...
from agent_tracer.decorators import traced_llm_call
from agent_tracer.context_capture import LLMContextCaptureMixin, LLMContext
...
@pytest.mark.asyncio
async def test_traced_llm_call_captures_context_and_extracts_decision():
...
@pytest.mark.asyncio
async def test_traced_llm_call_logs_alternatives():
...
@pytest.mark.asyncio
async def test_traced_llm_call_without_context_mixin():
...
@pytest.mark.asyncio
async def test_traced_llm_call_fail_safe_mode():
